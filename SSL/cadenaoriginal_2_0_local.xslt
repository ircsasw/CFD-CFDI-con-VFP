...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfd="http://www.sat.gob.mx/cfd/2" xmlns:ecc="http://www.sat.gob.mx/ecc" xmlns:donat="http://www.sat.gob.mx/donat" xmlns:psgecfd="http://www.sat.gob.mx/psgecfd" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:detallista="http://www.sat.gob.mx/detallista" xmlns:ecb="http://www.sat.gob.mx/ecb" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:iedu="http://www.sat.gob.mx/iedu" xmlns:psgcfdsp="http://www.sat.gob.mx/psgcfdsp">
	...
	-->
	<xsl:include href="<ssl-path>/ecc.xslt"/>
	<xsl:include href="<ssl-path>/psgecfd.xslt"/>
	<xsl:include href="<ssl-path>/donat.xslt"/>
	<xsl:include href="<ssl-path>/divisas.xslt"/>
	<xsl:include href="<ssl-path>/ecb.xslt"/>
	<xsl:include href="<ssl-path>/detallista.xslt"/>
	<xsl:include href="<ssl-path>/implocal.xslt"/>
	<xsl:include href="<ssl-path>/terceros.xslt"/>
	<xsl:include href="<ssl-path>/iedu.xslt"/>
	<xsl:include href="<ssl-path>/psgcfdsp.xslt"/>
